            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="btn btn-link text-white p-0 d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown">
                        <img src="https://ui-avatars.com/api/?name=Jaimil&background=8B5CF6&color=fff" alt="Admin" class="rounded-circle" width="35" height="35">
                        <span class="d-none d-md-inline">Jaimil</span>
                        <i class="fas fa-chevron-down" style="font-size: 12px;"></i>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end" style="background: #1a1a1a; border: 1px solid rgba(255, 255, 255, 0.1);">
                        <li><a class="dropdown-item text-white" href="profile.php"><i class="fas fa-user me-2"></i>Profile</a></li>
